...
public class NetManager {
    ...
    public static String BASEURL ="http://117.26.12.183:10000";
//    public static String BASEURL ="http://192.168.1.108:10000";
...
//                .cache(cache)
    ...
    public static class AppendHeaderParamIntercepter implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (User.isLogin()) {
                ...
                Headers newBuilder = builder
                        .add("Authorization", User.getTokenType() + User.getToken())
                        .build();
