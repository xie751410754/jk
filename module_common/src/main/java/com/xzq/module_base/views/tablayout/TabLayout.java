...
package com.xzq.module_base.views.tablayout;
...
public class TabLayout extends HorizontalScrollView {
    ...
    private int indicatorWidth = AdaptScreenUtils.pt2Px(20);
    ...
    public void addTab(@NonNull TabLayout.Tab tab, int position, boolean setSelected) {
        addOnTabSelectedListener(innerListener);
        if (tab.parent != this) {
            ...
            if (setSelected) {
                tab.select();
                innerListener.onTabSelected(tab);
            }
    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        public void draw(Canvas canvas) {
            ...
            if (this.indicatorLeft >= 0 && this.indicatorRight > this.indicatorLeft) {
                ...
                int offset = (this.indicatorRight - this.indicatorLeft - indicatorWidth) / 2;
                this.indicatorLeft = this.indicatorLeft + offset;
                this.indicatorRight = this.indicatorRight - offset;
    ...
    private final TabLayout.OnTabSelectedListener innerListener = new TabLayout.OnTabSelectedListener() {
        @Override
        public void onTabSelected(TabLayout.Tab tab) {
    ...
    private static void tabSelectedChange(TabLayout.Tab tab, boolean isSelected) {
        if (tab == null) {
            return;
        }
        if (tab.getCustomView() != null) {
            TextView tv = tab.getCustomView().findViewById(R.id.common_textView);
            if (tv != null) {
                tv.setTypeface(isSelected ? Typeface.DEFAULT_BOLD : Typeface.DEFAULT);
            }
        } else if (tab.view != null) {
            if (tab.view.textView != null) {
                tab.view.textView.setTypeface(isSelected ? Typeface.DEFAULT_BOLD : Typeface.DEFAULT);
            }
        }
    }
}
