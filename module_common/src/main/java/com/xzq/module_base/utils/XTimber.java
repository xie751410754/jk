...
public class XTimber {
    ...
    /**
     * Return a copy of toAll planted {@linkplain Tree trees}.
     */
    @NonNull
    ...
    /**
     * A {@link Tree} that delegates to toAll planted trees in the {@linkplain #FOREST forest}.
     */
    ...
    public static abstract class Tree {
        ...
        /**
         * 获取Log输出方法路径的模式，默认值是{@code MethodLocation.METHOD}
         *
         * @return Log输出方法路径的模式
         */
        ...
        private static StringBuilder getMethodTrace(MethodLocation type, StringBuilder builder) {
            ...
            if (stackTraceList != null && stackTraceList.length > 6) {
                StackTraceElement stackTraceElement = stackTraceList[6];
        ...
        /**
         * Write a log message to its destination. Called for toAll level-specific methods by default.
         *
